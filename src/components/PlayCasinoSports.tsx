...
export default function PlayCasinoSports() {
  return (
    <div className="flex gap-3">
      <div className="h-[170px] flex flex-col  rounded-sm overflow-hidden">
        ...
        <div className="px-4 flex justify-center items-center gap-1 w-full h-full bg-foreground rounded-b-sm">
